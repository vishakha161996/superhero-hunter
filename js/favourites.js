...
for(let i=0;i<localStorage.length;i++)
{
    ...
    // here I will add all the data of favourite character.
            templateCanvas.getElementById("thumbnail").innerHTML = '<img src="' + myStorage.thumbnail.path + '.' + myStorage.thumbnail.extension + '" style="height:auto;width:100%;padding-bottom:20px;"/>';
